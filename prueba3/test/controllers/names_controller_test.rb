...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { lastname: @name.lastname, password: @name.password, user_type: @name.user_type, username: @name.username } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { lastname: @name.lastname, password: @name.password, user_type: @name.user_type, username: @name.username } }, as: :json
    assert_response 200
  end
