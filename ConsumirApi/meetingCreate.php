...
<body>
    ...
    <div id = caja>
       <div class="form-group">
        ...
        <input id="meeting_title" type="text" class="form-control" placeholder="meeting_title" name="meeting_title">
      </div>
      <div class="form-group">
      ...
      <a id="create" type="submit" class="btn btn-success" onclick="saveMeetingAjax()">
      Registrar
   </a>
  </div>
</div> 
